...
local cfg_misc = {
    ...
    -- Font Stuff
    font = font_with_fallback("VictorMono Nerd Font", {bold = true , italic = true}),
    font_rules = {

        {
            italic = true,
            font = font_with_fallback("VictorMono Nerd Font", {italic = true})
        }, 
        {
            italic = true,
            intensity = "Bold",
        ...
        {
            intensity = "Bold",
            font = font_with_fallback("VictorMono Nerd Font", {bold = true})
        },
        {intensity = "Half", font = font_with_fallback("VictorMono Nerd Font")}
    },
    font_size = 11.0,
